...
public class DelPropRoomPayload {
    ...
    private DelPropRoomPayload(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        DelPropRoomPayload that = (DelPropRoomPayload) o;
    ...
    public static class Builder {
        ...
        public DelPropRoomPayload build() {
            return new DelPropRoomPayload(this);
        }
    }
