...
public class SearchPropPayload {
    ...
    private SearchPropPayload(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        SearchPropPayload that = (SearchPropPayload) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(segment, area, type, stars, category, amenities, longitude, latitude, limit);
    }
    ...
    public static class Builder {
        ...
        public SearchPropPayload build() {
            return new SearchPropPayload(this);
        }
    }
