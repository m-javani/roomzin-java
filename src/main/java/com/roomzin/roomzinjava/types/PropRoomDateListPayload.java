...
public class PropRoomDateListPayload {
    ...
    private PropRoomDateListPayload(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        PropRoomDateListPayload that = (PropRoomDateListPayload) o;
    ...
    public static class Builder {
        ...
        public PropRoomDateListPayload build() {
            return new PropRoomDateListPayload(this);
        }
    }
